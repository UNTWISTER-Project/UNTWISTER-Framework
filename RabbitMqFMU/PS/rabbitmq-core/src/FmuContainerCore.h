...
public:
    ...
    const string m_name;
    date::sys_time<std::chrono::milliseconds> lastTimestamp;
    bool stopmode = 0;
    double lastLeadAcceleration = -1.0;
    double lastEgoAcceleration = -1.0;
    ...
    void printStartOffsetTime(const date::sys_time<std::chrono::milliseconds>& startOffsetTime);
